 ...
 */
#ifndef RVO3D_RVO3D_SIMULATOR_H_
#define RVO3D_RVO3D_SIMULATOR_H_
...
namespace RVO {
	...
	public:
		 ...
		 * \return  The number of the agent, or RVO::RVO3D_ERROR when the agent defaults have not been set.
		 */
